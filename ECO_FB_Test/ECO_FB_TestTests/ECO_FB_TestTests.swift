...
//    }
    ...
    func testPaymentInfoAdd() async throws {
        ...
        let paymentInfo = PaymentInfo(id: id, userID: "idntno0505@gmail.com", paymentMethod: .bank, addressInfos: [AddressInfo(id: UUID().uuidString, recipientName: "홍재민", phoneNumber: "010-4534-2323", address: "구월3동")])
    ...
    func testPaymentInfoUpdate() async throws {
        ...
        let paymentInfo = PaymentInfo(id: id, userID: "idntno0505@gmail.com", paymentMethod: .bank, paymentMethodInfo: CardInfo(id: UUID().uuidString, cvc: "326", ownerName: "홍재민", cardNumber: "2315 2321 9898 2030", cardPassword: "1235", expirationDate: Date().getFormattedDate(dateString: "30-12", "yy-MM")), addressInfos: [AddressInfo(id: UUID().uuidString, recipientName: "홍재민", phoneNumber: "010-4534-2323", address: "구월3동"), AddressInfo(id: "RTG5zronTdUlpuBT1MxE", recipientName: "홍재민", phoneNumber: "010-2321-9899", address: "우리집")])
